...
// ---------------------------------------------------------------------
// Helper: find biomarker by name with alias support
// ---------------------------------------------------------------------
...
const BIOMARKER_ALIASES: Record<string, string[]> = {
  ...
  "Fasting Glucose": ["Fasting Glucose", "Fasting Blood Glucose", "FBG", "Glucose", "Glucose (Fasting)", "Glucose Fasting"],
  ...
  "WBC": ["WBC", "White Blood Cell Count", "Leukocyte Count", "White Blood Cells", "White Blood Cells (WBC)"],
  "hs-CRP": ["hs-CRP", "High-sensitivity C-reactive protein", "hsCRP", "CRP", "C-Reactive Protein", "High Sensitivity CRP", "C-Reactive Protein, High Sensitivity", "C-Reactive Protein (High Sensitivity)", "C-Reactive Protein (hsCRP)", "High Sensitivity C-Reactive Protein", "HS CRP", "CRP, High Sensitivity", "Ultra-Sensitive CRP", "Cardio CRP", "C-Reactive Protein, Cardiac"],
  "MCV": ["MCV", "Mean Corpuscular Volume"],
  "RDW": ["RDW", "Red Cell Distribution Width"],
  "Alkaline Phosphatase": ["Alkaline Phosphatase", "ALP", "Alkaline Phosphatase (ALP)"],
  "Lymphocytes": ["Lymphocytes", "Lymphocyte Count", "Lymphs", "Lymphocytes (%)", "Lymphocytes %"],
  ...
  "BUN": ["BUN", "Blood Urea Nitrogen", "Urea", "Urea (BUN)", "Urea Nitrogen"],
};
