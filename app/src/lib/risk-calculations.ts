...
const BIOMARKER_ALIASES: Record<string, string[]> = {
  ...
  "LDL Cholesterol": ["LDL Cholesterol", "LDL", "LDL-C", "Low-Density Lipoprotein"],
  "Triglycerides": ["Triglycerides", "TG", "Trigs"],
  "Non-HDL Cholesterol": ["Non-HDL Cholesterol", "Non-HDL", "Non-HDL-C"],
  "Fasting Glucose": ["Fasting Glucose", "Fasting Blood Glucose", "FBG", "Glucose"],
  "Fasting Insulin": ["Fasting Insulin", "Insulin"],
  "HbA1c": ["HbA1c", "Hemoglobin A1c", "A1C", "Glycated Hemoglobin"],
  ...
  "Free T3": ["Free T3", "fT3", "FT3"],
  "Free T4": ["Free T4", "fT4", "FT4"],
};
